...
from moleculartoolbox import VPT2_file
...
parser.add_argument('outfile',
                    metavar='Output file',
                    type=str, help='Cfour/Orca Output file or .vpt2 file')
parser.add_argument('-f', "--file",
                    action="store_true",
                    default=False,
                    dest="file_flag",
                    help=("Loads job data from .vpt2 file instead "
                          "[default: False]."))
...
if __name__ == '__main__':
    ...
    if not ARGS.file_flag:
        ...
        vpt2_f = VPT2_file(ARGS.outfile)
        geometry = vpt2_f.geometry
        harmonic = vpt2_f.harmonic
        moI = geometry.rot_prop.moment_of_inertia_tensor()
        ...
        print(PF.print_rigid_rotational_constants(geometry.rot_prop))
        print(PF.print_harmonics(harmonic))
        vpt2 = VPT2(harmonic, vpt2_f.cubic, vpt2_f.semiquartic,
                    print_level=1)
    ...
    print(PF.print_harmonic_VPT2_derivatives(vpt2_derivatives, harmonic))
